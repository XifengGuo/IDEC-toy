...
Usage:
    No pretrained autoencoder weights available:
        ...
        python IDEC.py reutersidf10k --update_interval 20
...
class IDEC(object):
    ...
    def initialize_model(self, x, ae_weights=None, pretrain_epochs=400, gamma=0.1, optimizer='adam'):
        if ae_weights is not None:  # load pretrained weights of autoencoder
            ...
            print 'Pretraining...'
            self.autoencoder.compile(optimizer=SGD(lr=0.01, momentum=0.9), loss='mse')
...
if __name__ == "__main__":
    ...
    idec.initialize_model(x, ae_weights=args.ae_weights, pretrain_epochs=args.pretrain_epochs,
